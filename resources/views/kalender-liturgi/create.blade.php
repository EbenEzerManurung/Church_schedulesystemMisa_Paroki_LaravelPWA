{{-- resources/views/kalender-liturgi/create.blade.php --}}

@extends('layouts.app')

@section('title', 'Tambah Kalender Liturgi')
@section('page-title', 'Tambah Kalender Liturgi Hari')

@section('content')
<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800">
            <i class="fas fa-plus-circle mr-2 text-green-600"></i> Tambah Kalender Liturgi
        </h1>
        ...
        <form action="{{ route('kalender-liturgi.store') }}" method="POST">
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="keterangan_hari" 
                               ...
                               value="{{ old('keterangan_hari') }}" required>
                    ...
                    <div>
                        ...
                        <select name="warna_liturgi" 
                            ...
                            @foreach($warnaList as $warna)
                                <option value="{{ $warna }}" {{ old('warna_liturgi') == $warna ? 'selected' : '' }}>
                                    {{ ucfirst($warna) }}
                                </option>
                            @endforeach
                        </select>
                        ...
                        <div class="mt-2 flex items-center gap-3">
                            ...
                            <span id="colorPreview" class="px-3 py-1 rounded-full text-sm font-medium bg-gray-200 text-gray-700">
                                Belum dipilih
                            </span>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center space-x-4 pt-2">
                            <label class="inline-flex items-center">
                                <input type="radio" name="is_active" value="1" 
                                       class="form-radio text-purple-600" {{ old('is_active', '1') == '1' ? 'checked' : '' }}>
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <div>
                            ...
                            <textarea name="bacaan1" rows="2" 
                                      ...
                                      placeholder="Contoh: 1 Kor 1:1-9">{{ old('bacaan1') }}</textarea>
                            @error('bacaan1')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="mazmur_tanggapan" rows="2" 
                                      ...
                                      placeholder="Contoh: Mzm 1:1-2,3,4,6">{{ old('mazmur_tanggapan') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea name="bait_pengantarinjil" rows="2" 
                                      ...
                                      placeholder="Contoh: Alleluia, Alleluia...">{{ old('bait_pengantarinjil') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea name="bacaan_injil" rows="2" 
                                      ...
                                      placeholder="Contoh: Mat 4:12-17">{{ old('bacaan_injil') }}</textarea>
                            @error('bacaan_injil')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="mt-8 border-t pt-6 flex justify-end gap-3">
                    ...
                    <button type="submit" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-6 rounded-lg transition">
