...
<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        <div class="flex space-x-2">
            ...
            <!-- Tombol Tambah -->
            <a href="{{ route('assignments.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg transition duration-200">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition duration-200">
                        ...
                        <!-- KOLOM KETERSEDIAAN (dari duty) -->
                        <td class="px-4 py-4 whitespace-nowrap text-center">
                            @php
                                $ketersediaan = $assignment->duty ? $assignment->duty->ketersediaan_status : null;
                            @endphp
                            @if($ketersediaan)
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold {{ $ketersediaan['badge'] }}" title="{{ $ketersediaan['message'] }}">
                                    <i class="fas {{ $ketersediaan['icon'] }} mr-1.5"></i>
                                    {{ $ketersediaan['label'] }}
                                </span>
                            @else
                                <span class="text-gray-400 text-xs">-</span>
