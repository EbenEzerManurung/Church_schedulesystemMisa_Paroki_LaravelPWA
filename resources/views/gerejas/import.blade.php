...
@section('title', 'Import Data Gereja')
@section('page-title', 'Import Data Gereja')

@section('content')
<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800">
            <i class="fas fa-upload mr-2"></i> Import Data Gereja
        </h1>
        <a href="{{ route('gerejas.index') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded-lg transition duration-200">
    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
        <div class="p-6">
                ...
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <ul class="list-disc list-inside mt-2 text-sm">
                            ...
                            <li>Kolom yang wajib diisi: <strong>nama</strong> dan <strong>kode_keuskupan</strong></li>
                            <li>Kode keuskupan bisa menggunakan kode (KSK001) atau nama keuskupan</li>
            ...
            <div class="mb-6">
                <a href="{{ route('gerejas.template') }}" class="inline-flex items-center px-4 py-2 bg-green-500 hover:bg-green-700 text-white rounded-lg transition duration-200">
                    <i class="fas fa-download mr-2"></i> Download Template Import
                </a>
            </div>

            <form action="{{ route('gerejas.import') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="flex justify-end space-x-3">
                    <a href="{{ route('gerejas.index') }}" class="px-6 py-2 bg-gray-300 text-gray-700 rounded-md hover:bg-gray-400 transition duration-200">
                        Batal
                    </a>
